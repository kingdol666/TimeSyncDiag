...
# ── 项目根目录 ──────────────────────────────────────────
# 此文件位于 backend/logic/utils/paths.py
# logic/ 向上 2 层 = backend/, 再向上 1 层 = TimeSyncDiag
LOGIC_DIR = Path(__file__).resolve().parent.parent  # backend/logic/
BACKEND_DIR = LOGIC_DIR.parent  # backend/
