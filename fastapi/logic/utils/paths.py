...
# ── 项目根目录 ──────────────────────────────────────────
# 此文件位于 fastapi/logic/utils/paths.py
# logic/ 向上 2 层 = fastapi/, 再向上 1 层 = TimeSyncDiag
LOGIC_DIR = Path(__file__).resolve().parent.parent  # fastapi/logic/
FASTAPI_DIR = LOGIC_DIR.parent  # fastapi/
